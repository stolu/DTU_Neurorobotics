...
if PLAST1_sinexp:
	GC_PC_p = {'weight'	  :  20.0,
			   'delay'    :  1.0,
			   'A_minus'  : -1.0,    #LTD double - Amplitude of weight change for depression  # double - Amplitude of weight change for depression
			   'A_plus'   :  0.0001,#0.015,  #LTP double - Amplitude of weight change for potentiation # double - Amplitude of weight change for facilitation 
			   'Wmin'     :  0.0,    # double - Minimal synaptic weight 
			   'Wmax'	  :  40.0}    # double - Maximal synaptic weight
...
IO_PC_p = {'weight'   :  1.0,#10.0, #1.0
		   'delay'    :  1.0}  #0.1
#### PC_DCN_p ####
PC_DCN_p = {'weight'  :  0.000015,#0.000014, #0.25,
			'delay'   :  1.0}  #0.1
#### MF_DCN_p ####
MF_DCN_p = {'weight'  :  0.000026,
			'delay'   :  10.0}  #0.1
################################################################