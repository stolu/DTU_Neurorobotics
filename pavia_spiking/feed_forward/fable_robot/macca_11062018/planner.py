...
@nrp.MapSpikeSource("MF_joint1_q_des",  nrp.map_neurons( range( 0,                                 nrp.config.brain_root.MF_number/4), lambda i: nrp.brain.MOSSY_j1[i]),  nrp.ac_source)
@nrp.MapSpikeSource("MF_joint1_qd_des", nrp.map_neurons( range( nrp.config.brain_root.MF_number/4, nrp.config.brain_root.MF_number/2), lambda i: nrp.brain.MOSSY_j1[i]),  nrp.ac_source)

@nrp.MapSpikeSource("MF_joint2_q_des",  nrp.map_neurons( range( 0,                                 nrp.config.brain_root.MF_number/4), lambda i: nrp.brain.MOSSY_j2[i]),  nrp.ac_source)
@nrp.MapSpikeSource("MF_joint2_qd_des", nrp.map_neurons( range( nrp.config.brain_root.MF_number/4, nrp.config.brain_root.MF_number/2), lambda i: nrp.brain.MOSSY_j2[i]),  nrp.ac_source)
...
def planner(t, debug_traj, trajectory_type, n_joints,
            ...
            MF_joint1_q_des, MF_joint1_qd_des, MF_joint2_q_des, MF_joint2_qd_des,
    ...
    MF_joint_q_des  = [MF_joint1_q_des, MF_joint2_q_des]
    MF_joint_qd_des = [MF_joint1_qd_des, MF_joint2_qd_des]	
    try:
