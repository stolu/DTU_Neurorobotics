...
@nrp.NeuronMonitor(nrp.brain.MF_0_0_cur_q+
                   nrp.brain.MF_0_0_des_q+
                   nrp.brain.MF_0_0_des_torque +
                   nrp.brain.MF_0_1_cur_q+
                   nrp.brain.MF_0_1_des_q+
                   nrp.brain.MF_0_1_des_torque+
                   nrp.brain.IO_0_0_pos_q+
                   nrp.brain.IO_0_0_neg_q+ 
                   nrp.brain.IO_0_1_pos_q+ 
                   nrp.brain.IO_0_1_neg_q+
                   nrp.brain.IO_0_0_pos_qd+
                   nrp.brain.IO_0_0_neg_qd+ 
                   nrp.brain.IO_0_1_pos_qd+ 
                   nrp.brain.IO_0_1_neg_qd+ 
                   nrp.brain.DCN_0_0_pos_q+ 
                   nrp.brain.DCN_0_0_neg_q+ 
                   nrp.brain.DCN_0_1_pos_q+ 
                   nrp.brain.DCN_0_1_neg_q+ 
                   nrp.brain.DCN_0_0_pos_qd+ 
                   nrp.brain.DCN_0_0_neg_qd+ 
                   nrp.brain.DCN_0_1_pos_qd+ 
                   nrp.brain.DCN_0_1_neg_qd, nrp.spike_recorder)
