...
class CerebTestTune:
    ...
    def __init__(self, TEST, RESULTS_PATH, MODULES, JOINTS, MODEL=default_model):
        self.test = TEST
        self.test_PID = "26"#"54", 200s simulation, 44" is 100s simulation, 28" is 60s simulation, "26" is 30s simulation
    ...
    def plot_contribution(self, path=None):
        ...
        plt.plot(control_data[:,0], control_data[:,1], 'k',label = title_cmd_c[1] )
        ...
        plt.plot(control_data[:,0], control_data[:,2], 'k',label = title_cmd_c[2] )
