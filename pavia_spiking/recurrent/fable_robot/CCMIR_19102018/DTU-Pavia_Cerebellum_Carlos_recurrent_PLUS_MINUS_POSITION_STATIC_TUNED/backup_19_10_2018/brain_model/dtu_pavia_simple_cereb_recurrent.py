...
import init_parameters_dtu_pavia_cereb_recurrent as ip
reload(ip)
# Map variables:
   ...
   excit                                                     inhib        
	...
	for module in range(ip.n_modules):
		for joint in range(ip.n_joints):
			...
			MF["MF_"+str(module)+"_"+str(joint)+"_cur_q_plus"]  = sim.create(MF_t, ip.MF_p, ip.MF_n/n_inputs_MF) # Mossy Fiber module "module" joint "joint", current position postaction
			MF["MF_"+str(module)+"_"+str(joint)+"_cur_q_minus"] = sim.create(MF_t, ip.MF_p, ip.MF_n/n_inputs_MF) # Mossy Fiber module "module" joint "joint", current position preaction
			...
			MF["MF_"+str(module)+"_"+str(joint)] = MF["MF_"+str(module)+"_"+str(joint)+"_cur_q_plus"] + MF["MF_"+str(module)+"_"+str(joint)+"_cur_q_minus"] + MF["MF_"+str(module)+"_"+str(joint)+"_des_q"] + MF["MF_"+str(module)+"_"+str(joint)+"_des_torque"]
	...
	# Create Auxiliary tools
		recdict = [{"to_file":True, "withgid":True, "withtime":  True, "label":"Spike_Detector_MF_0_0"},
				   {"to_file":True, "withgid":True, "withtime":  True, "label":"Spike_Detector_MF_0_0_cur_q_plus"},
				   {"to_file":True, "withgid":True, "withtime":  True, "label":"Spike_Detector_MF_0_0_cur_q_minus"},
				   ...
				   {"to_file":True, "withgid":True, "withtime":  True, "label":"Spike_Detector_MF_0_1_cur_q_plus"},
				   {"to_file":True, "withgid":True, "withtime":  True, "label":"Spike_Detector_MF_0_1_cur_q_minus"},
		...
		sim.nest.Connect(tuple(MF["MF_0_0_cur_q_plus"].all_cells),    [spikedetector[1]])
		sim.nest.Connect(tuple(MF["MF_0_0_cur_q_minus"].all_cells),    [spikedetector[2]])
		sim.nest.Connect(tuple(MF["MF_0_0_des_q"].all_cells),    [spikedetector[3]])
		sim.nest.Connect(tuple(MF["MF_0_0_des_torque"].all_cells),    [spikedetector[4]])
		sim.nest.Connect(tuple(GC["GC"].all_cells),        [spikedetector[5]])
		sim.nest.Connect(tuple(PC["PC_0_0"].all_cells),    [spikedetector[6]])
		sim.nest.Connect(tuple(PC["PC_0_0_pos"].all_cells),    [spikedetector[7]])
		sim.nest.Connect(tuple(PC["PC_0_0_neg"].all_cells),    [spikedetector[8]])
		sim.nest.Connect(tuple(IO["IO_0_0"].all_cells),    [spikedetector[9]])
		sim.nest.Connect(tuple(IO["IO_0_0_pos"].all_cells),    [spikedetector[10]])
		sim.nest.Connect(tuple(IO["IO_0_0_neg"].all_cells),    [spikedetector[11]])
		sim.nest.Connect(tuple(DCN["DCN_0_0"].all_cells),  [spikedetector[12]])
		sim.nest.Connect(tuple(DCN["DCN_0_0_pos"].all_cells),  [spikedetector[13]])
		sim.nest.Connect(tuple(DCN["DCN_0_0_neg"].all_cells),  [spikedetector[14]])

		sim.nest.Connect(tuple(MF["MF_0_1"].all_cells),    [spikedetector[15]])
		sim.nest.Connect(tuple(MF["MF_0_1_cur_q_plus"].all_cells),    [spikedetector[16]])
		sim.nest.Connect(tuple(MF["MF_0_1_cur_q_minus"].all_cells),    [spikedetector[17]])
		sim.nest.Connect(tuple(MF["MF_0_1_des_q"].all_cells),    [spikedetector[18]])
		sim.nest.Connect(tuple(MF["MF_0_1_des_torque"].all_cells),    [spikedetector[19]])
		sim.nest.Connect(tuple(PC["PC_0_1"].all_cells),    [spikedetector[20]])
		sim.nest.Connect(tuple(PC["PC_0_1_pos"].all_cells),    [spikedetector[21]])
		sim.nest.Connect(tuple(PC["PC_0_1_neg"].all_cells),    [spikedetector[22]])
		sim.nest.Connect(tuple(IO["IO_0_1"].all_cells),    [spikedetector[23]])
		sim.nest.Connect(tuple(IO["IO_0_1_pos"].all_cells),    [spikedetector[24]])
		sim.nest.Connect(tuple(IO["IO_0_1_neg"].all_cells),    [spikedetector[25]])
		sim.nest.Connect(tuple(DCN["DCN_0_1"].all_cells),  [spikedetector[26]])
		sim.nest.Connect(tuple(DCN["DCN_0_1_pos"].all_cells),  [spikedetector[27]])
		sim.nest.Connect(tuple(DCN["DCN_0_1_neg"].all_cells),  [spikedetector[28]])
		

	return MF["MF_0_0"], MF["MF_0_1"], MF["MF_0_0_cur_q_plus"], MF["MF_0_0_cur_q_minus"], MF["MF_0_1_cur_q_plus"], MF["MF_0_1_cur_q_minus"], MF["MF_0_0_des_q"], MF["MF_0_1_des_q"], MF["MF_0_0_des_torque"], MF["MF_0_1_des_torque"], GC["GC"], PC["PC_0_0"], PC["PC_0_1"], PC["PC_0_0_pos"], PC["PC_0_0_neg"], PC["PC_0_1_pos"], PC["PC_0_1_neg"], IO["IO_0_0"], IO["IO_0_1"], IO["IO_0_0_pos"], IO["IO_0_0_neg"], IO["IO_0_1_pos"], IO["IO_0_1_neg"], DCN["DCN_0_0"], DCN["DCN_0_1"], DCN["DCN_0_0_pos"], DCN["DCN_0_0_neg"], DCN["DCN_0_1_pos"], DCN["DCN_0_1_neg"]

# -----------------------------------------------------------------------#
MF_0_0, MF_0_1, MF_0_0_cur_q_plus, MF_0_0_cur_q_minus, MF_0_1_cur_q_plus, MF_0_1_cur_q_minus, MF_0_0_des_q, MF_0_1_des_q, MF_0_0_des_torque, MF_0_1_des_torque, GC, PC_0_0, PC_0_1, PC_0_0_pos, PC_0_0_neg, PC_0_1_pos, PC_0_1_neg, IO_0_0, IO_0_1, IO_0_0_pos, IO_0_0_neg, IO_0_1_pos, IO_0_1_neg, DCN_0_0, DCN_0_1, DCN_0_0_pos, DCN_0_0_neg, DCN_0_1_pos, DCN_0_1_neg = create_cerebellum()