...
def controller( t, debug, proxy, duration, fable_robot, 
				...
				DCN_0_0_pos, DCN_0_1_pos, DCN_0_0_neg, DCN_0_1_neg, motor1, motor2):
	...
	try:
		...
		k_scale_output = [57.0, 57.0]#[57.0, 57.0] #k_scale_output = (max_dcn_rate x n_dcn/2)/max_pos = 57.0 ####
		...
		for j in range(0, n_joints.value):
			try:
				...
				clientLogger.info("HEREEEEEEEEEEEEEEEEEE: "+str(e))
				clientLogger.info("error_q: "+str(error_q.value.data[j])) #IT DOES NOT EXIST FOR SOME REASON
