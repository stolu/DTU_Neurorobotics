...
import sys
sys.path.append("/home/dtu-neurorobotics/Documents/NRP/Experiments/fable_manipulation_dtu_spiking_cereb_recurrent_torque")
...
def planner(t, debug_traj, trajectory_type, n_joints,
			...
			MF_0_0_des_torque, MF_0_1_des_torque, radial_func_torque, desired_ee_trajectory_pub, desired_joints_trajectory_pub, desired_LF_torque):	
