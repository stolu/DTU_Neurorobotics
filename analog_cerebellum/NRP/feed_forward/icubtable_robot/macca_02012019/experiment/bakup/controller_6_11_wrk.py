...
def balance_control(t, 
    ...
    try:
        ...
        if t >3.:
            ...
            #static_control.control( desired_init.value.effort, current_joints.value.effort, t)

                
            controlcommand.value.data = static_control.PID
            ...
            command_recorder.record_entry(t,
                                          static_control.PID[0], DCNcommand.value.data[0], LWPRcommand.value.data[0], controlcommand.value.data[0],
                                          static_control.PID[1], DCNcommand.value.data[1], LWPRcommand.value.data[1], controlcommand.value.data[1],
                                          static_control.PID[2], DCNcommand.value.data[2], LWPRcommand.value.data[2], controlcommand.value.data[2]
                                              )
