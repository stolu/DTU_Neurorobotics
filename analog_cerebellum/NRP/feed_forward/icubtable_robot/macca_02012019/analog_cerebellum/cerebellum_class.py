...
class Cerebellum:
    ...
    def __init__(self,n_uml, n_out, n_input_mossy, n_input_mossy_vel, n_input_pf):
        ...
        self.input_mossy      = [0. for i in range( 0, self.n_uml)]
        self.input_mossy_vel      = [0. for i in range( 0, self.n_uml)]
        ...
        self.output_C_mossy    = [0. for i in range( 0, self.n_uml)] # np.zeros((nout), dtype = np.double)
        
        
        self.output_C_mossy_vel    = [0. for i in range( 0, self.n_uml)] # np.zeros((nout), dtype = np.double)
        ...
        self.IO_fbacktorq   = [0. for i in range( 0, self.n_uml)]
        self.vel_IO_fbacktorq   = [0. for i in range( 0, self.n_uml)]
        self.IO_fbacktorq_t   = [0. for i in range( 0, self.n_uml)]
        self.vel_IO_fbacktorq_t   = [0. for i in range( 0, self.n_uml)]
        
        # *** Synaptic weights ***
        
        # PF-PC synaptic weights
        # previous
        self.w_pf_pct = [0. for i in range( 0, self.n_uml)]
        #current
        self.w_pf_pc = [0. for i in range( 0, self.n_uml)]
        
        # previous
        self.w_pf_pct_vel = [0. for i in range( 0, self.n_uml)]
        #current        
        self.w_pf_pc_vel = [0. for i in range( 0, self.n_uml)]
        
        # PF-DCN synaptic weights
        # previous
        self.w_pc_dcnt = [0. for i in range( 0, self.n_uml)]
        #current  
        self.w_pc_dcn = [0. for i in range( 0, self.n_uml)]
        
        #current  
        self.w_pc_dcn_vel = [0. for i in range( 0, self.n_uml)]
        # previous
        self.w_pc_dcnt_vel = [0. for i in range( 0, self.n_uml)]
        
        # IO-DCN synaptic weights
        # previous
        self.w_io_dcnt = [0. for i in range( 0, self.n_uml)]
        #current
        self.w_io_dcn = [0. for i in range( 0, self.n_uml)]
        
        
        # previous
        self.w_io_dcnt_vel = [0. for i in range( 0, self.n_uml)]
        #current
        self.w_io_dcn_vel = [0. for i in range( 0, self.n_uml)]
        
        # MF-DCN synaptic weights
        # previous
        self.w_mf_dcnt =[0. for i in range( 0, self.n_uml)]
        #current
        self.w_mf_dcn = [0. for i in range( 0, self.n_uml)]
        
        
        # previous
        self.w_mf_dcnt_vel = [0. for i in range( 0, self.n_uml)]
        #current
        self.w_mf_dcn_vel =[0. for i in range( 0, self.n_uml)]
    ...
    def prediction(self, pos_error, vel_error):   
        ...
        for i in range(0,self.n_uml):
            ...
            if self.signal_normalization == 1:                
                self.IO_fbacktorq[i] = self.norma( abs(pos_error[i]) , self.min_teach_pos[i], self.max_teach_pos[i] , self.tau_norm_sign) #+ self.IO_fbacktorq_t[i] ) /2. # media errore precedente e corrente
                ...
                self.IO_fbacktorq[i] = abs(pos_error[i] )
