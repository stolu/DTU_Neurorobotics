...
if plot_joint == 1:
    ...
    plt.plot(joint_data[:,0], joint_data[:,5], 'r',label = title[5] )
    ...
    plt.plot(joint_data[:,0], joint_data[:,11], 'b',label = title[11])
    plt.ylim(y_range_limit)
    plt.xlabel('time [$\sec$]', fontsize=fntsz, color='black')
    ...
    plt.plot(joint_data[:,0], joint_data[:,6], 'r',label = title[6] )
    plt.ylim(y_range_limit)
    plt.legend()
    plt.ylabel('position [$ rad $]', fontsize=fntsz, color='black')
    plt.xlabel('time [$\sec$]', fontsize=fntsz, color='black')
    ...
    plt.plot(joint_data[:,0], joint_data[:,12], 'b',label = title[12])
    plt.ylim(y_range_limit)
    plt.ylabel('position error [ $ rad $ ] ', fontsize=fntsz, color='black')
    plt.xlabel('time [$\sec$]', fontsize=fntsz, color='black')
    plt.legend()
    ...
    plt.plot(joint_data[:,5], joint_data[:,6], 'r',label = 'desired trajectory xy-plane' )
    plt.legend()
    plt.ylabel('y', fontsize=fntsz, color='black')
    plt.xlabel('x', fontsize=fntsz, color='black')
    plt.grid(True)
    ...
    plt.subplot(sbplt+i)
    plt.title('$ joint_1 $ ')
    plt.plot(joint_data[:,0], joint_data[:,3], 'b',label = title[3])
    plt.plot(joint_data[:,0], joint_data[:,7], 'r',label = title[7] )
    #plt.ylim(y_range_limit)
    plt.legend()
    plt.ylabel('velocity [$ rad/s $]', fontsize=fntsz, color='black')
    plt.xlabel('time [$\sec$]', fontsize=fntsz, color='black')
    plt.grid(True)
    ...
    plt.subplot(sbplt+i)
    plt.title('$ joint_2 $ ')
    plt.plot(joint_data[:,0], joint_data[:,4], 'b',label = title[4])
...
if plot_control == 1:
    ...
    plt.plot(control_data[:,0], ( control_data[:,3]+ control_data[:,5] + control_data[:,7] ), 'c',label = 'lwpr + dcn + lf')
    plt.plot(control_data[:,0], (control_data[:,7] ), 'g',label = title_cmd[7] )
    plt.plot(control_data[:,0], (  control_data[:,5] ), 'r',label = title_cmd[5] )
    plt.plot(control_data[:,0], control_data[:,3], 'b-.',label = title_cmd[3] )
    ...
    plt.plot(control_data[:,0], ( control_data[:,4]+ control_data[:,6] + control_data[:,8] ), 'c',label = 'lwpr + dcn + lf' )
    plt.plot(control_data[:,0], ( control_data[:,8] ), 'g',label = title_cmd[8]  )
    plt.plot(control_data[:,0], ( control_data[:,6] ), 'r',label = title_cmd[6]  )
    plt.plot(control_data[:,0], control_data[:,4], 'b-.',label = title_cmd[4] )
    ...
    plt.plot(control_data[:,0], ( control_data[:,5] + control_data[:,7] ), 'g',label = title_cmd[7] )
    plt.plot(joint_data[:,0], joint_data[:,13], 'b',label = title[13])
    
    
    plt.legend()
    plt.ylabel('control input [$ N $] / error [$ rad $] ', fontsize=fntsz, color='black')
    plt.xlabel('time [$\sec$]', fontsize=fntsz, color='black')
    plt.grid(True)
    ...
    plt.subplot(sbplt+i)
    plt.title(' control input $joint_2$')
    plt.plot(control_data[:,0], (control_data[:,6] + control_data[:,8] ), 'g',label = title_cmd[8] )
