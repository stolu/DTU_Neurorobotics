...
scipy.io.savemat('TestForward_06_05_2016_Mac_loadI.mat', dict(x=x, y=y, q1=q1, q2=q2, q1d=q1d, q2d=q2d, posr1=posr[0], posr2=posr[1], velr1 = velr[0], velr2 = velr[1], errp1=errp[0], errp2=errp[1], torquesLF1=torquesLF[0], torquesLF2=torquesLF[1], torqLWPR1=torqLWPR[0], torqLWPR2=torqLWPR[1], Ctorques1=Ctorques[0], Ctorques2=Ctorques[1], torquestot1=torquestot[0], torquestot2=torquestot[1]))
