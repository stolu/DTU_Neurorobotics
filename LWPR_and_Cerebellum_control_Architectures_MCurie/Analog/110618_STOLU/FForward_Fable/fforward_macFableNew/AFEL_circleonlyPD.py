...
#       Ctorques[1, j] = 0
    ...
    errv[0, j+1] = (errp[0, j+1] - errp[0, j]) / t #(q1d[j] - velr[0, j+1]) #
    errv[1, j+1] = (errp[1, j+1] - errp[1, j]) / t #(q2d[j] - velr[1, j+1]) #
...
scipy.io.savemat('TestForward_01_04_2016_MaconlyPD.mat', dict(x=x, y=y, q1=q1, q2=q2, q1d=q1d, q2d=q2d, posr1=posr[0], posr2=posr[1], velr1 = velr[0], velr2 = velr[1], errp1=errp[0], errp2=errp[1], torquesLF1=torquesLF[0], torquesLF2=torquesLF[1], torqLWPR1=torqLWPR[0], torqLWPR2=torqLWPR[1], Ctorques1=Ctorques[0], Ctorques2=Ctorques[1], torquestot1=torquestot[0], torquestot2=torquestot[1]))
